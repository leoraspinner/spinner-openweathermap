...
class Main {
    ...
    public static void main(String[] args) {
        ...
        service.weatherNow(location, keyString, units)
                ...
                .subscribe(
                        response -> SwingUtilities.invokeLater(() -> frame.setTemperature(location, response.main.temp)),
                        throwable -> SwingUtilities.invokeLater(() -> frame.setError(throwable.getMessage())
                        )
                );
